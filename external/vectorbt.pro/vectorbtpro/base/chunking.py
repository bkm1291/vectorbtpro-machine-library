...
flex_array_1d_gl_slicer = FlexArraySlicer(mapper=group_lens_mapper)
"""Flexible 1-dimensional array slicer along the column axis based on group lengths."""

array_1d_gl_slicer = ArraySlicer(mapper=group_lens_mapper)
"""1-dimensional array slicer along the column axis based on group lengths."""
