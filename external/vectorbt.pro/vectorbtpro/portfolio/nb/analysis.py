...
@register_chunkable(
    ...
    arg_take_spec=dict(
        ...
        sim_start=base_ch.flex_array_1d_gl_slicer,
        sim_end=base_ch.flex_array_1d_gl_slicer,
    ),
    merge_func="column_stack",
)
@register_jitted(cache=True, tags={"can_parallel"})
...
@register_chunkable(
    ...
    arg_take_spec=dict(
        ...
        group_lens=ch.ArraySlicer(axis=0),
        cash_sharing=None,
        cash_deposits_raw=RepFunc(portfolio_ch.get_flex_array_cs_slicer),
        split_shared=None,
        weights=base_ch.flex_array_1d_gl_slicer,
        sim_start=base_ch.flex_array_1d_gl_slicer,
        sim_end=base_ch.flex_array_1d_gl_slicer,
    ),
    merge_func="column_stack",
