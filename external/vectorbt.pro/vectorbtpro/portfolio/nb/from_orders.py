...
def init_FOLastState_nb(
    ...
    """Initialize `vectorbtpro.portfolio.enums.FOLastState`.
    ...
    Returns:
        FOLastState: Instance of `vectorbtpro.portfolio.enums.FOLastState` with initialized arrays.
    """
...
@register_jitted(cache=True)
def copy_FOLastState_nb(last_state: FOLastState) -> FOLastState:
    """Create a copy of `vectorbtpro.portfolio.enums.FOLastState`.

    Args:
        last_state (FOLastState): Instance of `vectorbtpro.portfolio.enums.FOLastState` to copy.

    Returns:
        FOLastState: Copied instance of `vectorbtpro.portfolio.enums.FOLastState`.
    """
    return FOLastState(
...
def from_orders_nb(
    ...
    Args:
        ...
        last_state (Optional[FOLastState]): Last simulation state to initialize from.
        
            See `vectorbtpro.portfolio.enums.FOLastState`.
    ...
    if last_state is None:
        last_state_in = init_FOLastState_nb(
            target_shape=target_shape,
            group_lens=group_lens,
            init_cash=init_cash,
        ...
        last_state_in = copy_FOLastState_nb(last_state)
