...
class DuckDBData(DBData):
    ...
    def resolve_connection(
        cls,
        connection: tp.Union[None, tp.PathLike, DuckDBPyConnectionT] = None,
        read_only: bool = True,
        ...
        **connection_config,
        ...
        Args:
            connection (Union[None, PathLike, DuckDBPyConnection]): Database connection string or instance.
    ...
    def pull(
        ...
        **kwargs,
        ...
        """Override `vectorbtpro.data.custom.db.DBData.pull` to resolve and share the database
