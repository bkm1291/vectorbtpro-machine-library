...
def iter_symmetric_up_th_nb(down_th: float) -> float:
    ...
    Args:
        down_th (float): Negative threshold value (0.01 = 1%).
...
def iter_symmetric_down_th_nb(up_th: float) -> float:
    ...
    Args:
        up_th (float): Positive threshold value (0.01 = 1%).
...
def pivots_1d_nb(
    ...
    Args:
        ...
        up_th (FlexArray1dLike): Upper threshold for detecting peaks (0.01 = 1%).

            Provided as a scalar or per row.
        down_th (FlexArray1dLike): Lower threshold for detecting valleys (0.01 = 1%).
...
def pivots_nb(
    ...
    Args:
        ...
        up_th (FlexArray2dLike): Upper threshold for detecting peaks (0.01 = 1%).

            Provided as a scalar, or per row, column, or element.
        down_th (FlexArray2dLike): Lower threshold for detecting valleys (0.01 = 1%).
